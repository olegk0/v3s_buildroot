...
/// @param font_number The index of the font to use. Pass 0 for the first font
/// you declared with ::Add_font(), 1 for the second etc.
...
const char*
Font_name(int index);
/// Returns true if the font of this number is TrueType, false if it's a SFont
/// bitmap.
int
