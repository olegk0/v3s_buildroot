...
#define luaL_push_const(name, value) \
  ...
  luaL_push_const("KEY_UP", NEWT_KEY_UP);
  luaL_push_const("KEY_DOWN", NEWT_KEY_DOWN);
  luaL_push_const("KEY_LEFT", NEWT_KEY_LEFT);
  luaL_push_const("KEY_RIGHT", NEWT_KEY_RIGHT);
...
static int L_SetWidth(lua_State *L) {
  ...
  newtListboxSetWidth(com->p, width);
