...
SDL_VERSION = dumbbuffers
#SDL_SITE = https://github.com/OpenDingux/SDL.git
#SDL_SITE_METHOD = git
#SDL_SOURCE = opendingux.zip
#SDL_SITE = https://github.com/OpenDingux/SDL/archive/refs/heads
SDL_SITE = package/sdl/src
SDL_SITE_METHOD = local
...
define SDL_EXTRACT_CMDS
        unzip $(SDL_DL_DIR)/$(SDL_SOURCE) -d $(@D)
        mv $(@D)/`ls $(@D)`/* $(@D)
        #cp $(HOST_SDL_PKGDIR)/Makefile $(@D)
endef
...
SDL_DEPENDENCIES += libdrm drm_helper
else
