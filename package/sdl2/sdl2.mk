...
SDL2_VERSION = dumbbuffers
#SDL2_SITE = https://github.com/JohnnyonFlame/SDL-dumbbuffers.git
#SDL2_SITE_METHOD = git
SDL2_SOURCE = SDL2.zip
SDL2_SITE = https://github.com/JohnnyonFlame/SDL-dumbbuffers/archive/refs/heads
...
define SDL2_EXTRACT_CMDS
        unzip $(SDL2_DL_DIR)/$(SDL2_SOURCE) -d $(@D)
        mv $(@D)/`ls $(@D)`/* $(@D)
        #cp $(HOST_SDL2_PKGDIR)/Makefile $(@D)
endef
