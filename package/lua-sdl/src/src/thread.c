...
l_thread_create(lua_State* L)
{
  ...
  thread->ptr = SDL_CreateThread(callback, thread);
  if (thread->ptr == NULL) {
...
const luaL_Reg ThreadFunctions[] = { { "createThread", l_thread_create },
                                     { NULL, NULL } };
...
static const luaL_Reg ThreadMethods[] = { { "getId", l_thread_getId },
                                          { "getName", l_thread_getName },
                                          { "wait", l_thread_wait },
                                          { NULL, NULL } };

static const luaL_Reg ThreadMetamethods[] = { { "__eq", l_thread_eq },
                                              { "__gc", l_thread_gc },
                                              { "__tostring",
                                                l_thread_tostring },
                                              { NULL, NULL } };

const CommonObject Thread = { "LuaThread", ThreadMethods, ThreadMetamethods };
